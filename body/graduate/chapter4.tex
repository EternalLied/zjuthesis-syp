...
\begin{table}[!htbp]
    ...
    \setlength{\tabcolsep}{2mm}{ %7可随机设置，调整表格整体长度到适合自己的大小为止
        ...
        不量化 (DSGD)  & 763.8   & 763.8  &  & 790.9     & 790.9   \\
        2 & -   & \textbf{605.4}  &  & -     & \textbf{624}   \\
        4  & 647.1   & \textbf{489.6}  &  & 679.2     & \textbf{604.5}   \\
        8  & 555.7   & \textbf{538.2}  &  & 722.7     & \textbf{672.6}   \\ \hline
        \end{tabular}
    } %注意这里还有一个半括号
\end{table}
...
\begin{table}[!htbp]
    ...
    \setlength{\tabcolsep}{4mm}{ %7可随机设置，调整表格整体长度到适合自己的大小为止
        ...
        不量化 (DSGT)  & 1234.5   & 1234.5  &  & 1825.8     & 1825.8   \\
        2 & -   & \textbf{966.3}  &  & -     & \textbf{928.8}   \\
        4  & 1600.2   & \textbf{964.8}  &  & 1082.1     & \textbf{1028.6}   \\
        8  & 1280.4   & \textbf{1124.7}  &  & 1256.3     & \textbf{1118.4}   \\ \hline
        \end{tabular}
    } %注意这里还有一个半括号
\end{table}
