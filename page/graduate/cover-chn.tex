...
\begin{center}
    ...
    \begin{tabularx}{\textwidth}{l l >{\raggedleft}X l}
        ...
        学{\quad\quad}号： & \uline{\hfill 22132058 \hfill} 
    \end{tabularx}
\end{center}
...
\begin{center}
    ...
    \begin{tabularx}{0.95\textwidth}{>{\fangsong}l X<{\centering}}
        % If titles are too long for one row, please manually hardcode them in
        % multiple lines, as the english title example here.
        中文论文题目：      &  \uline{\hfill\fangsong
        面向分布式深度学习的训练时间预测\hfill} \\
        				   &  \uline{\hfill\fangsong 与优化方法研究                       \hfill} \\
        英文论文题目：      &  \uline{\hfill Research on Training Time Prediction and   \hfill} \\
        				   &  \uline{\hfill Optimization for Distributed Deep Learning              \hfill} \\
    \end{tabularx}
\end{center}
...
\begin{center}
    ...
    \begin{tabularx}{.65\textwidth}{>{\fangsong}l >{\fangsong}X<{\centering}}
        ...
        {%
            申请人姓名： & \uline{\hfill 闫昌智 \hfill} \\
            指导教师：   & \uline{\hfill 徐金明 \ 研究员 \hfill} \\
            ...
            {%
                专业名称：  &  \uline{\hfill 控制科学与工程 \hfill} \\
                研究方向：  &  \uline{\hfill 分布式优化 \hfill} \\
            }
