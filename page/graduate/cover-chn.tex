...
\begin{center}
    ...
    \begin{tabularx}{0.95\textwidth}{>{\fangsong}l X<{\centering}}
        % If titles are too long for one row, please manually hardcode them in
        % multiple lines, as the english title example here.
        中文论文题目：      &  \uline{\hfill\fangsong 分布式训练中的\hfill} \\
        				   &  \uline{\hfill\fangsong 通信优化方法研究                       \hfill} \\
        英文论文题目：      &  \uline{\hfill Research on Communication Optimization     \hfill} \\
        				   &  \uline{\hfill Methods in Distributed Training              \hfill} \\
    \end{tabularx}
\end{center}
