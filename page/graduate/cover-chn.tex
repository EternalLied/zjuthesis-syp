...
\begin{center}
    ...
    \begin{tabularx}{0.95\textwidth}{>{\fangsong}l X<{\centering}}
        ...
        面向分布式深度学习的训练时间预测与优化技术研究\hfill} \\
        % 				   &  \uline{\hfill\fangsong 检测技术研究                       \hfill} \\
        英文论文题目：      &  \uline{\hfill\normalsize {Optimization of Distributed Deep Learning Architecture} \hfill} \\
        				   &  \uline{\hfill\normalsize {Based on Performance Prediction}              \hfill} \\
    \end{tabularx}
\end{center}
...
\begin{center}
    ...
    \begin{tabularx}{.65\textwidth}{>{\fangsong}l >{\fangsong}X<{\centering}}
        ...
        {%
            ...
            {%
                专业名称：  &  \uline{\hfill 控制理论与控制工程 \hfill} \\
