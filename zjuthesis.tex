...
\documentclass[
    ...
    % TitleEng        = {{Optimization of Distributed Deep Learning Architecture Based on Performance Prediction}}
]{zjuthesis}

%% Uncomment the following lines if you need multi line titles on cover pages
% \titletwolines{面向分布式深度学习的训练时间预测与优化}{方法研究}
\titleengtwolines{\normalsize{Optimization of Distributed Deep Learning Architecture}}{\normalsize{Based on Performance Prediction}}
