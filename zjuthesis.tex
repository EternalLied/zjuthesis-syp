...
\documentclass[
    ...
    % Title
    % Title           = 通信高效的分布式训练加速方法研究,
    % TitleEng        = {{Research on Efficient Distributed Training Acceleration Methods}}
]{zjuthesis}

%% Uncomment the following lines if you need multi line titles on cover pages
\titletwolines{面向分布式训练的集合通信}{与计算通信并行优化研究}
\titleengtwolines
