...
\documentclass[
    ...
    % Title
    % Title           = 面向分布式深度学习的训练时间预测与优化方法研究,
    % TitleEng        = {{Research on Training Time Prediction and Optimization for Distributed Deep Learning}}
]{zjuthesis}

%% Uncomment the following lines if you need multi line titles on cover pages
\titletwolines{面向分布式深度学习的训练时间预测}{与优化方法研究}
\titleengtwolines{Research on Training Time Prediction and}{Optimization for Distributed Deep Learning}
